...
var _user$project$SolutionVisualizer$toSvgString = function (polygon) {
	return A2(
		_elm_lang$core$String$join,
		' ',
		A2(_elm_lang$core$List$map, _user$project$SolutionVisualizer$toCoord, polygon));
};
var _user$project$SolutionVisualizer$drawPolygon = function (polygon) {
	return A2(
		_elm_lang$svg$Svg$polygon,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$svg$Svg_Attributes$points(
				_user$project$SolutionVisualizer$toSvgString(polygon)),
...
var _user$project$SolutionVisualizer$update = F2(
...
var _user$project$SolutionVisualizer$view = function (model) {
	return A2(
		_elm_lang$svg$Svg$svg,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$svg$Svg_Attributes$width(
				_elm_lang$core$Basics$toString(200)),
				_elm_lang$svg$Svg_Attributes$height(
				_elm_lang$core$Basics$toString(200))
			]),
		A2(_elm_lang$core$List$map, _user$project$SolutionVisualizer$drawPolygon, model.polygons));
};
var _user$project$SolutionVisualizer$init = function (model) {
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		model,
		_elm_lang$core$Native_List.fromArray(
...
var _user$project$SolutionVisualizer$main = {
...
var _user$project$SolutionVisualizer$Rational = F2(
	function (a, b) {
		return {numerator: a, denominator: b};
	});
var _user$project$SolutionVisualizer$Point = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _user$project$SolutionVisualizer$Model = function (a) {
	return {polygons: a};
};

var Elm = {};
Elm['SolutionVisualizer'] = Elm['SolutionVisualizer'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['SolutionVisualizer'], 'SolutionVisualizer', typeof _user$project$SolutionVisualizer$main === 'undefined' ? null : _user$project$SolutionVisualizer$main);
