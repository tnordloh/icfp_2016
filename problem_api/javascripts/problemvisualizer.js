...
var _user$project$ProblemVisualizer$main = {
			...
			return A2(
				...
				A2(
					...
					_elm_lang$core$Json_Decode$list(
						A2(
							_elm_lang$core$Json_Decode$andThen,
							A2(_elm_lang$core$Json_Decode_ops[':='], 'negative', _elm_lang$core$Json_Decode$bool),
							function (negative) {
								return A2(
									_elm_lang$core$Json_Decode$andThen,
									A2(
									...
									function (vertices) {
										return _elm_lang$core$Json_Decode$succeed(
											{negative: negative, vertices: vertices});
									});
							}))),
				function (polygons) {
					return _elm_lang$core$Json_Decode$succeed(
...
var _user$project$ProblemVisualizer$Polygon = F2(
	function (a, b) {
		return {vertices: a, negative: b};
	});
var _user$project$ProblemVisualizer$Model = F2(
	function (a, b) {
		return {polygons: a, lines: b};
	});

var Elm = {};
Elm['ProblemVisualizer'] = Elm['ProblemVisualizer'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['ProblemVisualizer'], 'ProblemVisualizer', typeof _user$project$ProblemVisualizer$main === 'undefined' ? null : _user$project$ProblemVisualizer$main);
